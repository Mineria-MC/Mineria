...
{
    protected static final ResourceLocation TEXTURES = new ResourceLocation(References.MODID, "textures/gui/infuser.png");

    protected final IDrawableAnimated animatedBubbles;
    ...
    public AbstractInfuserRecipeCategory(IGuiHelper helper)
    {
        ...
        animatedBubbles = helper.createAnimatedDrawable(staticAnimation, 2400, IDrawableAnimated.StartDirection.LEFT, false);
    }
}
