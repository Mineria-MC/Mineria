...
public class DruidModel<T extends AbstractDruidEntity> extends SegmentedModel<T> implements IHasArm, IHasHead
{
    ...
    public DruidModel(float texStart, float yOffset, int texSizeX, int texSizeY)
    {
    ...
    public void setupAnim(T entity, float p1, float p2, float p3, float p4, float p5)
    {
        ...
        {
            this.rightArm.xRot = MathHelper.cos(p1 * 0.6662F + (float) Math.PI) * 2.0F * p2 * 0.5F;
            this.rightArm.yRot = 0.0F;
            this.rightArm.zRot = 0.0F;
            this.leftArm.xRot = MathHelper.cos(p1 * 0.6662F) * 2.0F * p2 * 0.5F;
            this.leftArm.yRot = 0.0F;
            this.leftArm.zRot = 0.0F;
        ...
        if (pose == AbstractDruidEntity.ArmPose.ATTACKING)
        {
            ...
            {
                ModelHelper.animateZombieArms(this.leftArm, this.rightArm, true, this.attackTime, p3);
            } else
            {
                ModelHelper.swingWeaponDown(this.rightArm, this.leftArm, entity, this.attackTime, p3);
            }
