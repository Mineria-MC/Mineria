...
import com.mineria.mod.common.entity.ElementaryGolemEntity;
import net.minecraft.client.renderer.entity.model.SegmentedModel;
import net.minecraft.client.renderer.model.ModelRenderer;
import net.minecraft.util.math.MathHelper;

public class FireGolemModel<T extends ElementaryGolemEntity> extends SegmentedModel<T>
{
    ...
    @Override
    public void setupAnim(T golem, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_)
    {
    ...
    @Override
    public void prepareMobModel(T golem, float p_212843_2_, float p_212843_3_, float p_212843_4_)
    {
