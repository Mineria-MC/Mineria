...
public class BrownBearModel extends QuadrupedModel<BrownBearEntity>
{
    public BrownBearModel()
    {
        ...
        ModelRenderer renderer = this.head.texOffs(26, 0);
        renderer.mirror = true;
        renderer.addBox(2.5F, -4.0F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F);
    ...
    @Override
    public void setupAnim(BrownBearEntity entity, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_)
    {
