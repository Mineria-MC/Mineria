...
public class EntityInit
{
	...
	{
		event.put(GOLDEN_SILVERFISH.get(), (MonsterEntity.func_234295_eP_().createMutableAttribute(Attributes.MAX_HEALTH, 11.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.30D).createMutableAttribute(Attributes.ATTACK_DAMAGE, 1.2D)).create());
	}
}
