...
public class ShapedRecipePredicate
{
    ...
    {
        if(MAX_HEIGHT == null) MAX_HEIGHT = ObfuscationReflectionHelper.findField(ShapedRecipe.class, "MAX_HEIGHT");
        try
        {
    ...
    {
        if(MAX_WIDTH == null) MAX_WIDTH = ObfuscationReflectionHelper.findField(ShapedRecipe.class, "MAX_WIDTH");
        try
        {
