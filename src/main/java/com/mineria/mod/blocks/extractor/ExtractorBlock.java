...
public class ExtractorBlock extends MineriaBlock
{
    ...
    {
        super(Material.IRON, 7.5F, 12.5F, SoundType.METAL, 2);
    ...
    {
        return TileEntitiesInit.EXTRACTOR.get().create();
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving)
    {
        ...
        if(tile instanceof ExtractorTileEntity && state.getBlock() != newState.getBlock())
            InventoryHelper.dropItems(worldIn, pos, ((ExtractorTileEntity)tile).getInventory().toNonNullList());
