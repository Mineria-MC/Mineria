...
public class BlockInfuser extends MineriaBlock implements ITileEntityProvider
{
    private static final PropertyDirection FACING = BlockHorizontal.FACING;
    private static final PropertyBool INFUSING = PropertyBool.create("infusing");

    public BlockInfuser()
    {
        super(Material.IRON, 5, 5, 1, "axe", SoundType.WOOD);
    ...
    {
        return state.getValue(INFUSING) ? 8 : 0;
    }
    ...
    {
        if (!worldIn.isRemote)
            playerIn.openGui(Mineria.INSTANCE, GuiHandler.GUI_INFUSER, worldIn, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        worldIn.setBlockState(pos, BlocksInit.INFUSER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(INFUSING, active), 3);
    ...
    {
        return new BlockStateContainer(this, FACING, INFUSING);
    }
}
