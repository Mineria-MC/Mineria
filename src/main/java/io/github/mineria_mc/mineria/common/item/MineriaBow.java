        ...
        if (living instanceof Player player) {
            ...
            if (!ammo.isEmpty() || infiniteArrows) {
                ...
                if (velocity >= (0.1D * this.velocityMultiplier)) {
                    boolean infiniteAmmo = player.getAbilities().instabuild || (ammo.getItem() instanceof ArrowItem && EnchantmentHelper.getItemEnchantmentLevel(Enchantments.INFINITY_ARROWS, bowStack) <= 0 ? false : ammo.getItem().getClass() == ArrowItem.class);
