...
public class MineriaBlocks {
    ...
    // Ore Blocks
    public static final RegistryObject<Block> LEAD_BLOCK = register("lead_block", () -> new Block(properties(MapColor.METAL, 6.5F, 20F, SoundType.METAL)));
    public static final RegistryObject<Block> TITANE_BLOCK = register("titane_block", () -> new Block(properties(MapColor.METAL, 10F, 15F, SoundType.METAL)));
    public static final RegistryObject<Block> LONSDALEITE_BLOCK = register("lonsdaleite_block", () -> new Block(Properties.of().mapColor(MapColor.METAL).strength(10F, 17.5F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> SILVER_BLOCK = register("silver_block", () -> new Block(properties(MapColor.METAL, 5F, 10F, SoundType.METAL)));
    public static final RegistryObject<Block> COMPRESSED_LEAD_BLOCK = register("compressed_lead_block", () -> new Block(properties(MapColor.METAL, 2.5F, 2F, SoundType.METAL)));
    ...
    // Plants
    public static final RegistryObject<Block> PLANTAIN = registerCompostable("plantain", () -> new PlantBlock(MapColor.PLANT, false), 0.4F);
    public static final RegistryObject<Block> MINT = registerCompostable("mint", () -> new PlantBlock(MapColor.PLANT, false), 0.5F);
    public static final RegistryObject<Block> THYME = registerCompostable("thyme", () -> new PlantBlock(MapColor.PLANT, false), 0.65F);
    public static final RegistryObject<Block> NETTLE = registerCompostable("nettle", () -> new PlantBlock(MapColor.PLANT, false), 0.7F);
    public static final RegistryObject<Block> PULMONARY = registerCompostable("pulmonary", () -> new PlantBlock(MapColor.PLANT, false), 0.5F);
    public static final RegistryObject<Block> RHUBARB = registerCompostable("rhubarb", () -> new PlantBlock(MapColor.PLANT, false), 0.4F);
    public static final RegistryObject<Block> SENNA = registerCompostable("senna", () -> new PlantBlock(MapColor.PLANT, false), 0.4F);
    public static final RegistryObject<Block> SENNA_BUSH = registerCompostable("senna_bush", () -> new PlantBlock(MapColor.PLANT, true), 0.5F);
    ...
    public static final RegistryObject<Block> BELLADONNA = registerCompostable("belladonna", () -> new PlantBlock(MapColor.PLANT, false), 0.65F);
    public static final RegistryObject<Block> MANDRAKE = registerCompostable("mandrake", () -> new PlantBlock(MapColor.PLANT, false), 0.6F);
    ...
    public static final RegistryObject<Block> SCHISANDRA_CHINENSIS = registerCompostable("schisandra_chinensis", () -> new VineBlock(Properties.of().mapColor(MapColor.PLANT).replaceable().ignitedByLava().pushReaction(PushReaction.DESTROY).noCollission().randomTicks().strength(0.2F).sound(SoundType.VINE)), 0.7F);
    public static final RegistryObject<Block> PULSATILLA_CHINENSIS = registerCompostable("pulsatilla_chinensis", () -> new PlantBlock(MapColor.PLANT, false), 0.65F);

    // Mushrooms
    public static final RegistryObject<Block> GIROLLE = registerCompostable("girolle", () -> new MineriaMushroomBlock(MapColor.COLOR_YELLOW), 0.55F);
    public static final RegistryObject<Block> HORN_OF_PLENTY = registerCompostable("horn_of_plenty", () -> new MineriaMushroomBlock(MapColor.COLOR_BROWN), 0.55F);
    ...
    // Other
    public static final RegistryObject<Block> BLUE_GLOWSTONE = register("blue_glowstone", () -> new Block(Properties.of().instrument(NoteBlockInstrument.HAT).strength(0.3F).sound(SoundType.GLASS).lightLevel(value -> 15)));
    public static final RegistryObject<Block> MINERAL_SAND = register("mineral_sand", () -> new FallingBlock(Properties.of().mapColor(MapColor.SAND).instrument(NoteBlockInstrument.SNARE).strength(0.5F).sound(SoundType.SAND)));
    ...
    public static final RegistryObject<Block> XP_WALL = register("xp_wall", () -> new Block(properties(MapColor.METAL, 2.5F, 5F, SoundType.METAL)));
    ...
    private static Properties deepslate(float hardness, float resistance) {
        return Properties.of().instrument(NoteBlockInstrument.BASEDRUM).mapColor(MapColor.DEEPSLATE).strength(hardness, resistance).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops();
    }

    private static Properties properties(MapColor mapColor, float hardness, float resistance, SoundType sound) {
        return Properties.of().mapColor(mapColor).strength(hardness, resistance).sound(sound).requiresCorrectToolForDrops();
    }
