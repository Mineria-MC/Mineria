...
import io.github.mineria_mc.mineria.common.effects.instances.*;
...
public class MineriaEffectInstanceSerializers {
    ...
    public static final RegistryObject<IMobEffectInstanceSerializer<PoisoningHiddenEffectInstance>> POISONING_HIDDEN_EFFECT = SERIALIZERS.register("poisoning_hidden_effect", PoisoningHiddenEffectInstance.Serializer::new);
